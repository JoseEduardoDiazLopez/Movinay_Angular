...
export class AuthService {
  ...
  URL1='https://movinay-backendv4-dev-afmp.3.us-1.fl0.io/api/autenticacion/register';
  URL2='https://movinay-backendv4-dev-afmp.3.us-1.fl0.io/api/autenticacion/login';
  URL3='https://movinay-backendv4-dev-afmp.3.us-1.fl0.io/api/autenticacion/'
